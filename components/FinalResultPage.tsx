      ...
      <div className="bg-white p-8 rounded-3xl shadow-xl border border-blue-50 mb-8 relative overflow-hidden">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-2">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-amber-900 font-bold text-sm">লোন অ্যাপ্লিকেশন ফি ২০ টাকা</p>
              <p className="text-amber-700 text-xs mt-0.5">আপনার লোন আবেদন প্রক্রিয়াকরণের জন্য ২০ টাকা অ্যাপ্লিকেশন ফি প্রদান করুন।</p>
            </div>
          </div>
        </div>
