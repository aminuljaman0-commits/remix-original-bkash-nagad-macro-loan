      ...
      <div className="max-w-lg w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center">
        ...
        <div className="bg-gray-900 rounded-2xl p-6 mb-6">
          ...
          <p className="text-gray-500 text-xs mt-3">
            {timeLeft > 0 ? 'আপনার আবেদন রিভিউ করা হচ্ছে... সময় শেষ হলে স্বয়ংক্রিয়ভাবে পরবর্তী ধাপে যাবে' : (!permGranted ? 'নোটিফিকেশন পারমিশন দিন, অন্যথায় আবেদন এগোবে না' : 'রিভিউ সম্পন্ন! পরবর্তী পেজে নিয়ে যাওয়া হচ্ছে...')}
          </p>
        </div>
